...
public class Jclientes extends javax.swing.JFrame {
    ...
    public Jclientes() {
        ...
        this.setTitle("Clientes -" + inicio.version);
    ...
    public void actualizar() {
        ...
        for (int i = 0; i < main.personasDAO.resultadoClientes.size(); i++) {
            ...
            fila[0] = main.personasDAO.resultadoClientes.get(i).getId();
            ...
            fila[4] = main.personasDAO.resultadoClientes.get(i).getCeltel();
            fila[5] = main.personasDAO.resultadoClientes.get(i).getCorreo();
    ...
    private void tableClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableClientesMouseClicked
        ...
        for (int i = 0; i < main.personasDAO.resultadoClientes.size(); i++) {
            ...
            if (filaSelecionada == main.personasDAO.resultadoClientes.get(i).getId()) {
                id = main.personasDAO.resultadoClientes.get(i).getId();

                txtCINRUC.setText("" + main.personasDAO.resultadoClientes.get(i).getCINRUC());
                txtNombres.setText("" + main.personasDAO.resultadoClientes.get(i).getNombres());
                txtApellidos.setText("" + main.personasDAO.resultadoClientes.get(i).getApellidos());
                txtCelTel.setText("" + main.personasDAO.resultadoClientes.get(i).getCeltel());
                txtDireccion.setText("" + main.personasDAO.resultadoClientes.get(i).getDireccion());
                txtCorreo.setText("" + main.personasDAO.resultadoClientes.get(i).getCorreo());
                txtCiudad.setText("" + main.personasDAO.resultadoClientes.get(i).getCiudad());

                try {
                    fechaT = main.personasDAO.resultadoClientes.get(i).getFecha();
    ...
    private void agregar() {
        ...
        try {
            ...
            if (inicio.gFechas.validarFecha(fecha)) {
                ...
                cliObj = new Clientes(null, CINRUC, nombres, apellidos, direccion, fecha, celtel, correo, inicio.userObj.getId(), ciudad);
                main.personasDAO.insertar(cliObj);
                actualizar();
                limpiar();
            } else {
                JOptionPane.showMessageDialog(null, "Datos Invalidos", "Agregar Clientes", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            // JOptionPane.showMessageDialog(null, "Campos Vacios o Inválidos", "Agregar Clientes", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void modificar() {
        ...
        try {
            ...
            if (inicio.gFechas.validarFecha(fecha)) {
                ...
                cliObj = new Clientes(id, CINRUC, nombres, apellidos, direccion, fecha, celtel, correo, inicio.userObj.getId(), ciudad);
                main.personasDAO.modificar(cliObj);
                actualizar();
                limpiar();
            } else {
                JOptionPane.showMessageDialog(null, "Datos Invalidos", "Agregar Clientes", JOptionPane.ERROR_MESSAGE);
    ...
    private void eliminar() {
       ...
       if(id!=-1){
        cliObj = new Clientes(id);
        main.personasDAO.eliminar(cliObj);
        actualizar();
        limpiar();
       }
